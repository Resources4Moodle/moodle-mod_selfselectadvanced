...
/**
 * Event fired when a student asks to join a team (strategy 1.19 B).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class join_requested extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventjoinrequested', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' asked to join group "
            . "'{$this->other['targetgroupid']}'.";
    }
