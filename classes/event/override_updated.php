...
/**
 * Event fired when an override is updated, carrying the actor, target,
...
class override_updated extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventoverrideupdated', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' updated a {$o['scope']}-scope override "
