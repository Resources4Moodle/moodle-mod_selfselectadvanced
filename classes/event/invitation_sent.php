...
/**
 * Event fired when a group invitation is sent.
 *
 * The member row is the object; the invitee is the related user.
 *
...
class invitation_sent extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventinvitationsent', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' invited the user with id '$this->relateduserid' "
            . "to the group '$uid'.";
    }
