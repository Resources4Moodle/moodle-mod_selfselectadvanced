...
/**
 * Event fired when a queue ticket changes: the claimant posted a
 * thread reply without closing it (1.20.46, tickets::comment() - the
 * LLM API's "respond" half of read+respond, but reachable by any
 * claimant, human or machine).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ticket_commented extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventticketcommented', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' posted a reply on the '$type' ticket with id "
