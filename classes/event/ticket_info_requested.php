...
/**
 * Event fired when a queue ticket changes: the claimant asked the
 * requester a question (maintainer decision 2, 2026-08-15).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ticket_info_requested extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventticketinforequested', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' asked the requester of the '$type' ticket with id "
            . "'$this->objectid' a question in the activity with course module id "
