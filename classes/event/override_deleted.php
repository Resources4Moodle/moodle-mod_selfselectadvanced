...
/**
 * Event fired when an override is deleted, carrying the actor, target,
...
class override_deleted extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventoverridedeleted', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' deleted a {$o['scope']}-scope override "
