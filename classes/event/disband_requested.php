...
/**
 * Event fired when a leader's disband request is filed (decision 63).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class disband_requested extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventdisbandrequested', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The leader asked the members of group '$uid' to wind the team up (actor: user id '$this->userid').";
    }
