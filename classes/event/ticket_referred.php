...
/**
 * Event fired when a queue ticket changes: the claimant referred it to
 * another coordinator (1.20.44, the handling ladder's "refer" rung).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class ticket_referred extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventticketreferred', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' referred the '$type' ticket with id "
            . "'$this->objectid' to the user with id '$this->relateduserid' in the activity with "
