...
/**
 * Event fired when a department or programme is added to the site-wide
 * attribute vocabulary (AUTH-001/LOG-001, 1.20.4).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dept_created extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventdeptcreated', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' added the $kind '$name' "
            . "(id '$this->objectid') to the attribute vocabulary.";
    }
