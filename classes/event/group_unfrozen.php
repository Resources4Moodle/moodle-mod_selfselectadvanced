...
/**
 * Event fired when a group is unfrozen (spec 12).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class group_unfrozen extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventgroupunfrozen', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' unfroze the group '$uid'.";
    }
