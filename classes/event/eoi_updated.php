...
/**
 * Event fired when an expression of interest changes status: accepted,
 * rejected, expired or withdrawn.
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class eoi_updated extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventeoiupdated', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The expression of interest with id '$this->objectid' moved to status '$status' "
    ...
    protected function validate_data(): void {
        ...
        if (!isset($this->other['status'])) {
            throw new \coding_exception('The status must be set in other.');
        }
    }
}
