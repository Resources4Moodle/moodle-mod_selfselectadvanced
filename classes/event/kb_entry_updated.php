...
/**
 * Event fired when a knowledgebank entry is edited (1.20.45).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class kb_entry_updated extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventkbentryupdated', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        return "The user with id '$this->userid' updated the knowledgebank entry with id "
