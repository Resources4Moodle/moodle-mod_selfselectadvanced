...
/**
 * Event fired when a group is approved in guide review (spec 6.5).
 *
 * @package    mod_selfselectadvanced
 * @copyright  2026 JSP <jsp@jsp.net.in>
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class group_approved extends \core\event\base {
    /**
    ...
    public static function get_name(): string {
        return get_string('eventgroupapproved', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The group '$uid' was approved by its guide and became firm (actor: user id '$this->userid').";
    }
