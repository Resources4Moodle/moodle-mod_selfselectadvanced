...
/**
 * Event fired when a department or programme is removed from the
 * site-wide attribute vocabulary (AUTH-003/LOG-001, 1.20.4).
 *
...
class dept_deleted extends \core\event\base {
    ...
    public static function get_name(): string {
        return get_string('eventdeptdeleted', 'mod_selfselectadvanced');
    }
    ...
    public function get_description(): string {
        ...
        return "The user with id '$this->userid' removed the $kind '$name' "
            . "(id '$this->objectid') from the attribute vocabulary.";
    }
